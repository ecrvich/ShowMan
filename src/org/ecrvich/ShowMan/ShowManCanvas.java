      ...
      extends Canvas
{
   ...
   public ShowManCanvas( int width, int height, int font_size, boolean thumb )
   {
   ...
   public ShowManCanvas( Image image, String name, int font_size, boolean thumb )
   {
   ...
   public boolean loadImage( Image img, String imgName, int font_size, boolean thumb )
   {
   ...
   private Image scaleImage( Image img )
   {
      ...
      if (hscale < 1.0)
      {
         ...
         rc = img.getScaledInstance( new_width, new_height, Image.SCALE_DEFAULT );
         img.flush();
      }
      return (rc);
   }
